...
4. Following the [Makefile](TODO:SURESH)
...
4. Follow the [Makefile](TODO:SURESH) for building and flashing the Verilog code: (run the following steps)
     - Run 'make clean' to clear any previous builds
     - Run 'make build' to compile the design
     - Run 'sudo make flash' to program the FPGA board
...
1. Create the following files ([Makefile](TODO:SURESH), [uart_trx](TODO:SURESH) - verilog, [top module](TODO:SURESH) - verilog, [pcf file](TODO:SURESH)) in a folder under VSDSquadronFM. In this case, I have named it *uart_loopback*.
...
1. Create the following [files](TODO:SURESH)in a folder under VSDSquadron_FM.
...
## Result:
![image](TODO:SURESH)
code can be found [here](TODO:SURESH)
